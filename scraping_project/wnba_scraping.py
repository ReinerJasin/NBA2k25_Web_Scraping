...
driver.get(BASE_URL + "wnba-teams/")
...
for current_team in current_teams:
    ...
    if team_a_tag:
        ...
        team_name_url.add(team_name.replace("https://www.2kratings.com/wnba-teams/", ""))
        # print(team_a_tag)
...
# for team_name_url in ('atlanta-hawks', 'boston-celtics'):
    driver.get(BASE_URL + '/wnba-teams/' + team_name_url)
    page_source = driver.page_source
    soup = BeautifulSoup(page_source, "html.parser")
    ...
    for current_player in current_players:
        ...
        if player_a_tag:
            ...
            player_name_url.add(player_name.replace("https://www.2kratings.com/wnba/", ""))
            print(player_name)
